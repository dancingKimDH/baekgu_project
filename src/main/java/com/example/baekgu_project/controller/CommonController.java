...
public class CommonController {
    ...
    public ModelAndView updateCommunity(@PathVariable String UNIQUE_ID, @RequestParam Map params,
    ...
    public ModelAndView deleteCommunity(@PathVariable String UNIQUE_ID, @RequestParam Map params,
            ModelAndView modelAndView) {
    ...
    public ModelAndView deleteAdmin(@PathVariable String UNIQUE_ID, @RequestParam Map params,
            ModelAndView modelAndView) {
        Object result = commonService.deleteAndSelectSearch(UNIQUE_ID, params);
        modelAndView.addObject("params", params);
        modelAndView.addObject("result", result);
