...
<body>
    <main>
                    ...
                    <div style="text-align: center; margin-top: 10px; margin-bottom: 10px;">
                        <ul class="list-unstyled m-0" style="display: inline-block;">
                            <li style="display: inline-block;">
                                <a href="#" class="text-white text-decoration-none ps-3" style="font-size: 1.3rem;">사이트
                                    소개</a>
                            </li>
                            <li style="display: inline-block;">
                                <a href="#" class="text-white text-decoration-none ps-3" style="font-size: 1.3rem;">다이어리
                                    사용 안내</a>
                            </li>
                            <li style="display: inline-block;">
        ...
        <div class="content-section">
            <div class="container_userguide" style="display: inline-block;">
                <div class="userguide">
                    <div class="guide-title" style="text-align: center;">이용 안내</div>
                    <!-- <div class="guide-item"> -->
                        ...
                        <div class="guide-content">
                            <img src="./images/문서03.png" alt="Image">
                        </div>
                    <!-- </div> -->
                    <!-- <div class="guide-item"> -->
                        <div class="guide-image">
                        ...
                        <div class="guide-content">
                            <img src="./images/문서04.png" alt="Image">
                        </div>
                    <!-- </div> -->
                    <!-- <div class="guide-item"> -->
                        <div class="guide-image">
                        ...
                        <div class="guide-content">
                            <img src="./images/솜뭉탱까만콩.jpg" alt="Image">
                        </div>
                    <!-- </div> -->
                </div>
            </div>
    ...
    <footer class="p-5 d-flex justify-content-between align-items-center">
        ...
        <div class="row">
            <img src="./images/logoimage.png" alt="logo" height="80rem" />
        </div>
    </footer>
