...
(
  ...
  MEMBER_ID         VARCHAR(500) NOT NULL COMMENT '가입회원_ID',
...
CREATE TABLE GENDER
(
  GENDER_ID   VARCHAR(500) NOT NULL COMMENT '성별_ID',
...
(
  ...
  PW         VARCHAR(500) NOT NULL COMMENT '비밀번호',
  EMAIL      VARCHAR(500) NOT NULL COMMENT '이메일',
  NAME       VARCHAR(500) NOT NULL COMMENT '이름',
  GENDER_ID  VARCHAR(500) NOT NULL COMMENT '성별_ID',
  BIRTHDATE  INTEGER(250) NOT NULL COMMENT '생년월일',
  TELECOM_ID VARCHAR(500) NOT NULL COMMENT '통신사_ID',
  PHONENUM   INTEGER(250) NOT NULL COMMENT '휴대폰번호',
  REGANI_ID  VARCHAR(500) NOT NULL COMMENT '등록 펫_ID',
  MEMBER_ID  VARCHAR(500) NOT NULL COMMENT '가입회원_ID',
...
(
  ...
  PETGEN_ID   VARCHAR(500) NOT NULL COMMENT '펫 성별_ID',
  PETINF_NAME VARCHAR(500) NOT NULL COMMENT '펫 별 정보 이름',
...
ALTER TABLE COMMUNITY_LIST
  ADD CONSTRAINT FK_MEMBER_TO_COMMUNITY_LIST
    FOREIGN KEY (MEMBER_ID)
    REFERENCES MEMBER (MEMBER_ID);

ALTER TABLE COMMUNITY_LIST
  ADD CONSTRAINT FK_WRITING_GROUP_TO_COMMUNITY_LIST
    FOREIGN KEY (WRITINGGROUP_ID)
    REFERENCES WRITING_GROUP (WRITINGGROUP_ID);
