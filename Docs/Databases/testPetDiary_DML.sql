...
VALUES
  ('C-01', '꽃챌린지', 'mem001', '2023-05-10', 'CL-001'),
  ('C-02', '신도림역 근처 괜찮은 고양이 병원 있을까요?', 'mem002', '2023-05-15', 'CL-002'),
  ('C-02', '여의도역 근처에 고슴도치 진료하는 병원 있을까요?', 'mem003', '2023-06-02', 'CL-003'),
  ('C-03', '강아지 사료 추천받아요', 'mem004', '2023-06-10', 'CL-004'),
  ('C-01', '물속성 고양이', 'mem005', '2023-06-16', 'CL-005'),
  ('C-04', '펫박람회 추천템!!', 'mem006', '2023-06-16', 'CL-006'),
  ('C-03', '앵무새 간식은 뭐가 좋을까요?', 'mem007', '2023-06-20', 'CL-007'),
  ('C-02', '홍제역 근처에 유기동물 케어해주는 병원이 있을까요?', 'mem008', '2023-06-24', 'CL-008'),
  ('C-01', '취미로 수제간식 만들기', 'mem009', '2023-06-29', 'CL-009'),
  ('C-04', '제가 잘때 토끼가 자꾸 머리카락을 먹는데 어떻게해야...??', 'mem010', '2023-07-03', 'CL-010');
